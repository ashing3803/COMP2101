...
# make a Pictures directory if we have not  - consider we have a home directory
...
# download a tarfile of pictures to our Pictures directory if its not its already there -  consider you are online
...
#unpack the downloaded tarfile if it is already there  then remove  the local copy of the tarfile
